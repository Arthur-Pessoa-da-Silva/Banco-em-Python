...
├── banco.py       # Operações bancárias
├── usuario.py     # Cadastro e autenticação
├── dados.py       # Salvamento e carregamento dos dados
├── dados.json     # Dados persistidos do usuário
